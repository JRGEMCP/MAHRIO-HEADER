...
export class SessionComponent {
  static get parameters(){
    return [BsModalService, ActivatedRoute, OauthSessionService, NotificationService, GithubService];
  }
  constructor(bsModalService, activateRoute, oauthSession, notificationService, githubService){
